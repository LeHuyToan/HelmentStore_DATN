...
const schema = yup.object().shape({
    ...
    giaBan: yup.number().required('Giá bán không được để trống').min(50000, 'Giá phải lớn hơn hoặc bằng 50.000 đ').max(10000000, 'Giá bán không lớn hơn 10.000.000 đ'),
...
<template>
    ...
    <div>
        <Dialog v-model:visible="productDialog" :style="{ width: '1100px' }" header="Thêm Mới Sản Phẩm" :modal="true" class="p-fluid">
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="p-fluid formgrid grid">
                            <div class="Field col-12 md:col-6" style="margin-bottom: 30px">
                                ...
                                <div class="Field col-12 md:col-12" style="margin-bottom: 30px">
                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="QuaiDeo" type="radio" inputId="ingredient1" name="QuaiDeo" value="Quai đeo cố định" :class="{ 'p-invalid': quaiDeoError }" checked />
                                ...
                                <div class="Field col-12 md:col-12" style="margin-bottom: 30px">
                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="DemLot" inputId="ingredient1" name="pizza" value="Bọt biển " :class="{ 'p-invalid': demLotError }" checked />
                            ...
                            <div class="Field col-12 md:col-6">
                                <div class="Field col-12 md:col-12" style="margin-bottom: 30px; margin-left: 60px; height: 300px; margin-top: 60px; display: inline-flex; justify-content: center; align-items: center; display: block">
                                ...
                                <div class="field col-12 md:col-12">
                                    <div style="background: rgb(255, 255, 255); width: 450px; display: flex">
                                        <div style="background: rgb(255, 255, 255); width: 20%; height: 100%">
                                            <div v-for="(mau, index) in selectedSizes" :key="index" style="margin-top: 40px; margin-bottom: 50px; margin-left: 70px">
                                                <label :for="`input-${mau.id}`" style="margin-right: 5px; margin-left: 0px; margin-top: 0px; margin-bottom: 0">{{ mau.ten }}</label>
                                            </div>
                                        </div>
                                        <div style="background: rgb(255, 255, 255); width: 80%; height: 100%">
                                            <div v-for="(color, index) in selectedMauSac" :key="index" class="mausac-container" style="display: inline-block; margin-bottom: 15px; height: 90x; width: 150px; margin-left: 10px">
                                                <div>
                                                    <p style="padding: 5px 0">
                                                        Màu: <span class="product-name">{{ color.ten }}</span>
                                                    </p>
                                                </div>
                                        ...
                                        <div style="width: 100%; height: 100%; display: flex; flex-wrap: wrap">
                                            <div style="width: 20%; height: 100%">
                                                <div style="display: flex; flex-wrap: wrap">
                                                    <div v-for="(mau, index) in selectedSizes" :key="index" style="margin-top: 5px; margin-left: 30px">
                                                        <label :for="`input-${mau.id}`" style="margin-right: 5px; margin-left: 0px">{{ mau.ten }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="width: 80%; height: 100%">
                                                <div style="display: flex; flex-wrap: wrap">
                                                    <div v-for="(mau, index) in selectedMauSac" :key="index" style="margin-top: 5px">
                                                        <label :for="`input-${mau.id}`" style="margin-right: 10px; margin-left: 10px"
                                                            >{{ mau.ten }} <span v-if="mau.size !== null"> - {{ mau.size.ten }}</span></label
                                                        >
                                                        <input
                                                            type="number"
                                                            :id="`input-${mau.id}`"
                                ...
                                <div class="field col-12 md:col-12">
                                    <div style="background: rgb(255, 255, 255); width: 450px; display: flex">
                                        ...
                                        <div style="background: rgb(255, 255, 255); width: 80%; height: 100%; display: ">
                                            <div style="display: flex; flex-wrap: wrap">
                                                <div v-for="(mau, index) in selectedMauSac" :key="index" style="margin-top: 5px">
                                                    <label :for="`input-${mau.id}`" style="margin-right: 10px; margin-left: 10px">{{ mau.ten }}</label>
                                                    <input
                                                        type="number"
                                                        :id="`input-${mau.id}`"
