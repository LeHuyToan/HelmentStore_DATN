...
<template>
    ...
    <div id="sales-invoice" hidden>
        <table style="width: 100%; font-size: 0.8rem">
            <tr style="border: 1px solid white">
                ...
                <td><strong style="text-align: right; margin: 0; font-size: 0.9rem">Cửa hàng Mũ bảo hiểm LHT</strong></td>
            </tr>
            <tr style="border: 1px solid white">
        ...
        <table style="margin-top: 1rem; border-collapse: collapse; width: 100%">
            ...
            <tbody>
                <tr v-for="(hdct, itemObjKey) in dsHDCT">
                    <td>{{ itemObjKey + 1 }}</td>
                    <td>
                        {{ hdct.sanPhamChiTiet.sanPham.ten }} - {{ hdct.sanPhamChiTiet.mauSac.ten }} - size
    ...
    <div class="card">
        <div class="row">
            ...
            <div class="col-3" style="margin-top: 0px; width: 350px; height: 340px">
                ...
                <div class="card" style="width: 100%; height: 100%">
                    <DataTable :value="dsHDCT" tableStyle="height: 200px" dataKey="id" scrollable scrollHeight="205px" showGridlines>
                        ...
                        <Column field="sanPhamChiTiet.sanPham.ten" header="Tên sản phẩm">
                            <template #body="slotProps"> Mũ bảo hiểm {{ slotProps.data.sanPhamChiTiet.sanPham.ten }} - {{ slotProps.data.sanPhamChiTiet.mauSac.ten }} - size {{ slotProps.data.sanPhamChiTiet.size.ten }} </template>
                        </Column>
                ...
                <div class="card" style="width: 100%">
                    ...
                    >
                        ...
                        <Column field="sanPham.ten" header="Tên sản phẩm">
                            <template #body="slotProps">
                                Mũ bảo hiểm {{ slotProps.data.sanPham.thuongHieu.ten }}
                                {{ slotProps.data.sanPham.ten }}
                            </template>
                        </Column>

                        <Column header="Màu sắc" filterField="mauSac.ten" :showFilterMatchModes="false" :filterMenuStyle="{ width: '14rem' }">
                            <template #body="{ data }">
                        ...
                        <Column header="Size" filterField="size.ten" :showFilterMatchModes="false" :filterMenuStyle="{ width: '14rem' }">
                            <template #body="{ data }">
                                <div class="flex align-items-center gap-2">
