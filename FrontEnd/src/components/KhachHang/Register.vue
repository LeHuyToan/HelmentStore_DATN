...
<template>
    <div class="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
        ...
        <div class="flex flex-column align-items-center justify-content-center">
            <router-link class="font-medium ml-2 text-right" :to="{ name: 'trang-chu' }"><img src="/src/assets/images/logo.png" alt="Sakai logo" class="mb-5 w-6rem flex-shrink-0" /></router-link>
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px; margin-bottom: 20px">
                    <router-link class="font-medium ml-2 text-right" :to="{ name: 'login' }"><i class="pi pi-arrow-left"></i> Quay lại đăng nhập</router-link>
                            ...
                            <div class="p-fluid formgrid grid">
                                ...
                                <div class="Field col-12 md:col-6" style="display: flex">
                                    <div>
                                        ...
                                        <Calendar dateFormat="mm/dd/yy" placeholder="Nhập ngày sinh" v-model="ngaySinh" :class="{ 'p-invalid': ngaySinhError }" class="w-full md:w-10rem mb-5" />

                                        <small class="p-error">{{ ngaySinhError }}</small>
                                    </div>
                                </div>
                                <div class="Field col-12 md:col-12 flex flex-wrap gap-3" style="margin-bottom: 20px; justify-content: left">
